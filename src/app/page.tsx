    ...
    <Layout>
      <section className="container section">
        <div className="grid gap-10 md:grid-cols-[1.2fr_0.8fr]">
          <div className="stack">
            <p className="text-xs uppercase tracking-[0.35em] text-[var(--sb-ink)]/60">
          ...
          <div className="rounded-3xl border border-[var(--sb-ink)]/10 bg-[var(--color-muted)] p-6">
            <h2 className="text-lg">{t.home.focusAreas}</h2>
      ...
      <section className="container section">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {highlightProjects.map((project) => {
            const localizedProject = getProjectCopy(project, locale);
            ...
            return (
              ...
              >
                <div>
                  <h3 className="text-lg">{localizedProject.title}</h3>
                  <p className="text-sm text-[var(--sb-ink)]/70">{localizedProject.summary}</p>
                </div>
